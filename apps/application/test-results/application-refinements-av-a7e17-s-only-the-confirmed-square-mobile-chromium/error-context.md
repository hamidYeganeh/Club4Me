...
- Name: application-refinements.spec.ts >> avatar crop can be cancelled and uploads only the confirmed square
- Location: e2e/application-refinements.spec.ts:70:5
...
```
Error: locator.setInputFiles: Test timeout of 45000ms exceeded.
Call log:
...
```yaml
- generic [ref=e2]:
  - status "Gym4Me" [ref=e3]:
    - img "Gym4Me" [ref=e4]
  - status "در حال بارگذاری محتوا" [ref=e9]:
    - status "در حال بارگذاری محتوا" [ref=e17]
```
