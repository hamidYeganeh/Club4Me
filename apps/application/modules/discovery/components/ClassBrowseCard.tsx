...
export function ClassBrowseCard({
  title,
  description,
  imageUrl,
  href,
  ...
  return (
    <Link
      href={href}
      aria-label={title}
      className="class-browse-card group overflow-hidden rounded-[2rem] bg-surface text-foreground outline-none transition-shadow focus-visible:ring-2 focus-visible:ring-focus focus-visible:ring-offset-4"
    >
      {imageUrl ? (
