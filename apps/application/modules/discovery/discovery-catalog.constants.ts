...
export const DISCOVERY_CATEGORIES = {
  ...
  "club-types": [
    ...
    },
    {
      id: "sport-complex",
      title: "مجموعه ورزشی",
      subtitle: "چند سالن و رشته در یک مجموعه",
    ...
    },
    {
      id: "academy",
      title: "آکادمی تخصصی",
      subtitle: "آموزش حرفه‌ای و استعدادیابی",
    ...
    },
    {
      id: "martial-arts",
      title: "سالن رزمی",
      subtitle: "بوکس، کاراته و ورزش‌های رزمی",
      imageUrl: unsplash("photo-1549719386-74dfcbf7dbed"),
    },
    {
      id: "football-field",
      title: "زمین فوتبال",
      subtitle: "زمین چمن و سالن فوتبال",
      imageUrl: unsplash("photo-1574629810360-7efbbe195018"),
    },
    {
      id: "tennis",
      title: "باشگاه تنیس",
      subtitle: "زمین تنیس و آموزش",
      imageUrl: unsplash("photo-1554068865-24cecd4e34b8"),
    },
    {
      id: "volleyball",
      title: "سالن والیبال",
      subtitle: "سالن اختصاصی والیبال",
      imageUrl: unsplash("photo-1612872087720-bb876e2e67d1"),
    },
  ],
  regions: [
    {
