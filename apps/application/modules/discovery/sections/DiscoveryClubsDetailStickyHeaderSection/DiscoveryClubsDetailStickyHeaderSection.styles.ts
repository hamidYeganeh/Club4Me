...
export const discoveryClubsDetailStickyHeaderSectionStyles = tv({
  slots: {
    root: "fixed inset-x-0 top-0 z-30 mx-auto h-[calc(78px+env(safe-area-inset-top))] w-full max-w-xl rounded-b-3xl bg-surface px-4 pb-4 pt-[calc(env(safe-area-inset-top)+16px)] transition-all duration-300 ease-out",
