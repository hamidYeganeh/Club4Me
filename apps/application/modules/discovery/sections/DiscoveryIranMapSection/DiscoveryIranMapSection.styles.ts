...
export const discoveryIranMapSectionStyles = tv({
  slots: {
    ...
    province:
      "cursor-pointer stroke-background/80 transition-[fill-opacity,stroke,filter] duration-200 outline-none hover:fill-opacity-100 hover:stroke-accent focus-visible:fill-opacity-100 focus-visible:stroke-accent ",
    detail:
    ...
    action:
      "flex h-10 shrink-0 items-center justify-center gap-2 rounded-full bg-accent/12 px-4 text-sm font-bold text-accent transition-[background-color,transform] hover:bg-accent/18 sm:mt-2 sm:w-full",
    source:
