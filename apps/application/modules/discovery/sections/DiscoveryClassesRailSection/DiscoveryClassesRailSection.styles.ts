...
export const discoveryClassesRailSectionStyles = tv({
  slots: {
    ...
    card: "group relative w-[min(72vw,16.5rem)] min-w-[min(72vw,16.5rem)] shrink-0 snap-start no-underline outline-none transition-transform duration-200 ease-out focus-visible:ring-2 focus-visible:ring-focus",
    imageWrap:
    ...
    skeleton:
      "aspect-[4/3] w-[min(72vw,16.5rem)] min-w-[min(72vw,16.5rem)] shrink-0 rounded-2xl bg-surface/72",
  },
});
