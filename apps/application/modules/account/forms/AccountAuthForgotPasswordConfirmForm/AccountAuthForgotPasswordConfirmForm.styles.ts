...
export const accountAuthForgotPasswordConfirmFormStyles = tv({
  slots: {
    ...
    otp: "min-w-0 w-full justify-center [direction:ltr] [&>fieldset]:w-full [&>fieldset]:min-w-0",
    otpGroup:
      "w-full justify-between gap-2 [direction:ltr] sm:justify-center sm:gap-3",
    slot: "aspect-square h-16 w-auto min-w-0 flex-1 basis-0 rounded-2xl border border-border bg-surface text-xl font-medium shadow-none sm:size-16 sm:flex-none sm:basis-16",
    resend:
