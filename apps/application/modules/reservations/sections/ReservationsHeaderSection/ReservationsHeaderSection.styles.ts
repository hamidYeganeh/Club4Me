...
export const reservationsHeaderSectionStyles = tv({
  slots: {
    ...
    dateButton:
      "group flex h-auto min-h-[4.55rem] w-[4.15rem] min-w-[4.15rem] snap-start flex-col items-center justify-center gap-1 rounded-[1.15rem] border border-transparent bg-background px-3 py-2.5 text-foreground shadow-none transition-[transform,border-color,background-color,color] duration-300 ease-out active:scale-95",
  ...
  variants: {
    ...
    selected: {
      true: {
        dateButton: "border-accent bg-accent text-accent-foreground",
