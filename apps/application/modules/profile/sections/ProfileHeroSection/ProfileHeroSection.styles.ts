...
export const profileHeroSectionStyles = tv({
  slots: {
    ...
    sideButton:
      "!size-12 !min-w-12 !rounded-[1.1rem] border border-white/8 bg-background/72 shadow-[0_10px_24px_color-mix(in_oklch,var(--background)_55%,transparent)] backdrop-blur-xl [&_.icon]:!text-[18px]",
    avatarLink:
