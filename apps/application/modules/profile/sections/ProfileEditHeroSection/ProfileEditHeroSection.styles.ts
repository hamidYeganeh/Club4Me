...
export const profileEditHeroSectionStyles = tv({
  slots: {
    root: "relative rounded-b-[3rem] bg-surface/72 px-5 pb-8 pt-[max(0.75rem,env(safe-area-inset-top))] backdrop-blur-xl",
    ...
    avatarBadge:
      "size-7 min-w-7 bg-foreground text-background",
  },
});
