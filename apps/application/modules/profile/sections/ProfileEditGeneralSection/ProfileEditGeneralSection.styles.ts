...
export const profileEditGeneralSectionStyles = tv({
  slots: {
    root: "flex flex-1 flex-col bg-transparent px-5 pb-10 pt-7",
    ...
    phoneGroup: "app-surface h-14 rounded-[1.15rem]",
    ...
    phoneTrigger:
      "flex h-8 min-h-8 w-auto items-center gap-1 border-0 bg-transparent px-0 shadow-none",
