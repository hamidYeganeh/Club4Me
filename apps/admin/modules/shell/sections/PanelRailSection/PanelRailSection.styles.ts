...
export const panelRailSectionStyles = tv({
  slots: {
    root: "z-40 flex shrink-0 items-center justify-between gap-3 bg-surface/75 px-3 py-3 backdrop-blur-2xl lg:sticky lg:top-0 lg:h-dvh lg:w-[5.25rem] lg:flex-col lg:border-b-0 lg:px-3 lg:py-5",
