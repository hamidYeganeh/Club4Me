...
export const panelRailSectionStyles = tv({
  slots: {
    ...
    add: "size-11 rounded-[1.15rem] bg-accent text-accent-foreground shadow-[0_0_24px_color-mix(in_oklch,var(--accent)_45%,transparent)]",
    ...
    itemActive:
      "bg-accent/15 text-accent shadow-[0_0_18px_color-mix(in_oklch,var(--accent)_28%,transparent)]",
    avatarWrap: "shrink-0",
  },
});
