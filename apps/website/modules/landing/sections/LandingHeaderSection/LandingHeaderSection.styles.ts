...
export const landingHeaderSectionStyles = tv({
  slots: {
    ...
    bar: "pointer-events-auto relative z-40 mx-auto flex h-16 max-w-6xl items-center justify-between gap-3 rounded-full bg-surface/80 px-2 pe-2 ps-3 backdrop-blur-xl",
