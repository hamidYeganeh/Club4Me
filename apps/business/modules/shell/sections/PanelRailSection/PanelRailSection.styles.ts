...
export const panelRailSectionStyles = tv({
  slots: {
    ...
    nav: "flex min-w-0 flex-1 items-center justify-start gap-1 overflow-x-auto lg:flex-col lg:justify-center lg:gap-2 lg:overflow-visible",
    item: "flex size-11 shrink-0 items-center justify-center rounded-2xl text-muted transition-colors duration-200 hover:bg-surface-secondary hover:text-foreground",
